    ...
    <div className='bg-gray-500 h-96 min-w-[100px] m-10 sm:justify-items-center'>
      <div className='grid p-6'>
         ...
         <div className='grid grid-cols-2 m-3 justify-items-center gap-2'>
          <div><button className='bg-blue-500 h-10 w-24 text-white'>Convert</button></div>
          <div><button className='bg-blue-500 h-10 w-24 text-white text-lg' 
          onClick={()=>{
          setAmount(0)
          setFrom('usd')
          setTo('inr')}}>Reset</button></div>
         </div>
         <div className='grid justify-items-center m-2 sm:text-4xl' style={{fontFamily:'cursive'}}>
            convert {amount} {from} to {to}={currencyInfo[to]*amount}
         </div>
      </div>
    </div>
    </>
